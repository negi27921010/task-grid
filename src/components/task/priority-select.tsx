  ...
  return (
    <DropdownMenu.Root>
      <DropdownMenu.Trigger asChild>
        <button
          type="button"
          className="inline-flex items-center gap-1.5 rounded-md px-2 py-1 text-xs font-medium transition-colors hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1"
        ...
        {ALL_PRIORITIES.map((priority) => (
          <DropdownMenu.Item
            ...
            className={cn(
              ...
              priority === currentPriority && 'bg-gray-50 font-medium'
            )}
